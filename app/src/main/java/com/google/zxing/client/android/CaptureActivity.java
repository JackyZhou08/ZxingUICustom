...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    /**
     * rawResult.getBarcodeFormat().toString()   QR_CODE
     * resultHandler.getType().toString()        TEXT
     * rawResult.getTimestamp()                  时间戳
     * rawResult.getResultMetadata()             H
     * resultHandler.getDisplayContents()        扫描的内容
     *
     * @param rawResult
     * @param barcode       二维码的截图
     */
